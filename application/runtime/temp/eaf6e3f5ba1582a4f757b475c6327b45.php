<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/var/www/html/public/../application/admin/view/index/content.html";i:1475063543;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="row  border-bottom white-bg dashboard-header">
    <div class="col-sm-12">
        <blockquote class="text-warning" style="font-size:14px">雪狐ThinkPHP5内容管理系统第一季正在完善中…
            <br>非常感谢您的关注和支持…
            <br>…………
    ...
    <div class="col-sm-3">
        ...
        <br>
        <br>
        <img src="__STATIC__/img/qr_code.png" width="100%" style="max-width:264px;">
        <br>
    </div>
    <div class="col-sm-5">
        <h2>
        ...
        <p>
            <b>雪狐StudyFoxCMS视频教程第一季：</b><span class="label label-warning">&yen; 460</span>
        </p>
        <br>
        <p>
            <a class="btn btn-success btn-outline" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2608818666&amp;site=qq&amp;menu=yes" target="_blank">
                <i class="fa fa-qq"> </i> 联系客服
            </a>
            <a class="btn btn-white btn-bitbucket" href="http://www.studyfox.cn/" target="_blank">
                <i class="fa fa-home"></i> 访问雪狐网
            </a>
        </p>
    </div>
    <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <p>我们提供基于StudyFoxCMS的二次开发服务，具体费用请联系客服。</p>
                    <p></p>
                    <ol>
                        <li>客服QQ：2608818666</li>
                    </ol>
                </div>
            </div>
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <p><i class="fa fa-send-o"></i> 网站：<a href="http://www.studyfox.cn/" target="_blank">http://www.studyfox.cn</a>
                    </p>
                    <p><i class="fa fa-qq"></i> QQ：<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=2608818666&amp;site=qq&amp;menu=yes" target="_blank">2608818666</a>
                    </p>
                    <p><i class="fa fa-weixin"></i> 微信：<a href="javascript:;">studyfox</a>
                    </p>
                    <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">fvfqtr@vip.qq.com / *亚</a>
                    </p>
                </div>
            </div>
        </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#version" href="#v41">v1.1.0</a><code class="pull-right">2016.02.29</code>
                                    </h5>
                                </div>
                                <div id="v41" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <div class="alert alert-warning">开始进入后台开发</div>
                                        <ol>
                                            <li>完成后台登录和注册功能</li>
                                            <li>后台页面加载</li>
                                        </ol>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#version" href="#v11">v1.0.0</a><code class="pull-right">2016.02.14</code>
                                    </h4>
                                </div>
                                <div id="v11" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ol>
                                            <li>StudyFoxCMS项目正式启动。</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-sm-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <p>购买后我可以获得什么？</p>
                    <ol>
                        <li>雪狐ThinkPHP5内容管理系统第一季(PC版)全套视频教程（目前正在录制，未结束）；</li>
                        <li>课程中所有源码；</li>
                        <li>免费客服答疑；</li>
                        <li>付费二次开发服务；</li>
                        <li>……</li>
                    ...
                    <hr>
                    <p>如需购买StudyFoxCMS视频教程或<a href="http://www.studyfox.cn" target="_blank">雪狐网</a>其她课程，可直接付款到支付宝：<a href="javascript:;">fvfqtr@vip.qq.com</a>，收款人：<a href="javascript:;">*亚</a>。也可以使用手机支付宝扫码支付：</p>
                    <div class="alert alert-warning">
                        付款完成后请及时联系
                        <br>雪狐网唯一客服QQ：2608818666
                    </div>
                    <p id="pay-qrcode">
                        <a href="javascript:;"><img src="__STATIC__/img/pay.png" width="100%" alt="请使用手机支付宝扫码支付">
                        </a>
                    </p>
...
<script src="__STATIC__/js/welcome.min.js"></script>
</body>
